...
class RadiologyProceduresController extends Controller
{
	...
	public function count(Request $request){
	    ...
	    $data = [
	        'count' => $this->radiologyProcedures(),
	        'title' => $this->getTitle()
	    ];
	...
	public function radiologyProceduresOrderProvider(){
	    $record = Order::from(Order::getTableName().' as o')
    		...
    		->where("o.order_type" ,"=" ,Order::$TYPE_RAD)
	...
	public function radiologyProceduresPriority(){
	    $record = Order::from(Order::getTableName().' as o')
    	    ->join(Patient_visit::getTableName().' as pv', 'o.patientvisitid','=','pv.id')
    	    ->join(Patient_type::getTableName().' as pt','pv.patienttype','=','pt.id')
    	    ->join(Patient_location::getTableName().' as pl','pv.assignedpatientlocation','=','pl.id')
	...
	public function radiologyProceduresHospitalService(){
	    $record = Order::from(Order::getTableName().' as o')
    	    ->join(Patient_visit::getTableName().' as pv', 'o.patientvisitid','=','pv.id')
    	    ->join(Patient_type::getTableName().' as pt','pv.patienttype','=','pt.id')
    	    ->join(Patient_location::getTableName().' as pl','pv.assignedpatientlocation','=','pl.id')
	...
	public function radiologyProceduresDay(){
	...
	public function radiologyProceduresWeek(){
	...
	public function radiologyProceduresMonth(){
	    $results = Order::from(Order::getTableName().' as o')
    	    ->join(Patient_visit::getTableName().' as pv', 'o.patientvisitid','=','pv.id')
    	    ->join(Patient_type::getTableName().' as pt','pv.patienttype','=','pt.id')
    	    ->join(Patient_location::getTableName().' as pl','pv.assignedpatientlocation','=','pl.id')
	...
	public function getHelper(){
		...
		$record = Metric::where('uid','=',Metric::$TYPE_RP)->first();
	...
	public function radiologyProceduresWeekFromtoEnd(Request $request) {
	...
	public function radiologyProceduresMonthYear(Request $request) {
