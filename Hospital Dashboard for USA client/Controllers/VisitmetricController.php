...
class VisitmetricController extends Controller
{
    ...
    public function visitsProvider(){
    ...
    public function visitsHours(){
        $data  = [
            [ "y" => 60, "label" => "Past 24 Hours", "indexLabel" => "60" ],
            [ "y" => 35, "label" => "Past 24 Hours", "indexLabel" => "35" ],
            [ "y" => 49, "label" => "Past 24 Hours", "indexLabel" => "49" ]  
        ];
        return json_encode($data);
    }
    ...
    public function visitsweekfromtoend(Request $request){
    ...
    public function visitsmonthyear(Request $request){
    ...
    public function getHelper(){
        ...
        $record = Metric::where('uid','=',Metric::$TYPE_VI)->first();
